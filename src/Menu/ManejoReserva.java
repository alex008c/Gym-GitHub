...
public class ManejoReserva {
    public void GuardarDatos (String id, String idsala, String idcliente, String dia, String mes, String anio, String idhorareser, String idestareser) throws IOException
    {
        try
        {
            FileWriter F1=new FileWriter("Reserva.txt", true);
            PrintWriter pw=new PrintWriter(F1);
            pw.println(id +";"+ idsala +";"+ idcliente +";"+ dia +";"+ mes +";"+ anio +";"+ idhorareser +";"+ idestareser);
            pw.close();
        }catch(Exception ex) {
    ...
    public void ModificaDatos(String LineaNueva, String id )
    {
        ...
        File fNuevo= new File("Reserva2.txt");
        File fAntiguo= new File("Reserva.txt");
